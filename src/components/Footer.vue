  ...
  <footer>
    <div class="bg-black">
      <div class="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
        <div class="mb-0 text-base text-gray-100 uppercase">
          Have a Project in mind?
        </div>
        <div>
          <a
            class="mb-10 text-2xl font-bold leading-none text-gray-100 transition duration-500 hover:text-green-400"
      ...
      <div
        class="max-w-screen-xl px-4 pt-12 pb-8 mx-auto sm:px-6 md:flex md:items-center md:justify-between lg:px-8"
      >
        <div class="flex mb-8 md:mb-0 md:order-2">
          <a
            href="https://twitter.com/bryandugan"
            target="_blank"
            class="text-gray-100 hover:text-green-400"
          >
        ...
        <div class="md:mt-0 md:order-1">
          <div class="mb-4 text-sm text-gray-100 md:mb-0">
