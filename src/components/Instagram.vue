<template>
  ...
  >
    <div class="pt-16 pb-32 border-t md:flex md:pt-24">
      <div class="w-full mb-12 md:w-1/3 lg:w-1/3 lg:mb-0 md:mr-12">
        ...
        <div class="text-gray-600">
          Follow my profile
          <a
            class="text-green-800 underline hover:text-green-500"
            href="https://instagram.com/bryan.dugan"
            target="_blank"
            >@bryan.dugan</a
          >
          for cat pictures, board games, vinyl collecting, bike adventures and
          every once in a while, some design tips.
        </div>
      </div>
      <div
        class="grid w-full grid-cols-2 gap-8 md:w-2/3 lg:w-2/3 md:grid-cols-2 lg:grid-cols-3"
      >
        <a
          v-for="edge in $page.photos.edges.slice(0, 6)"
          :key="edge.node.id"
